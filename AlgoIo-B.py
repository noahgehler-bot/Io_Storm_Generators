...
def generate_io_b(spec, freq_grid, dt=0.1, duration=900, center_freq=20e6, width=5e6):
...
def generate_noise():
    ...
    spec = generate_io_b(spec, freq_grid, dt=0.1, duration=900, center_freq=20e6, width=5e6)
